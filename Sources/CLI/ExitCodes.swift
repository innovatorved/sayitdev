// ============================================================================
// ExitCodes.swift - CLI exit-code constants and SayItDevError -> exit-code mapping.
// Part of SayItDevCLI so the mapping is unit-testable; main.swift delegates here.
//
// Exit codes are a stable CLI contract documented in the man page. Changes
// here must stay in sync with `dev.1` and with the bidirectional-coverage
...
/// Stable CLI exit codes and the `SayItDevError` -> exit-code mapping.
/// Documented in the man page; regression-locked by `ExitCodeMapTests`.
public enum SayItDevExitCodes {
    ...
    public static let micPermissionDenied: Int32 = 8
    public static let speechAssetFailed: Int32 = 9
    public static let noInputDevice: Int32 = 10

    /// Map a classified `SayItDevError` to its documented CLI exit code.
    public static func code(for error: SayItDevError) -> Int32 {
        switch error {
