...
`SayItDevCore` does not perform FoundationModels calls itself. It gives you the policy types you can apply around your own transcript or prompt-building logic.
