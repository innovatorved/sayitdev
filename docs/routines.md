...
dev uses Anthropic Claude Code **routines** - scheduled or webhook-triggered Claude Code sessions that run on Anthropic's cloud infrastructure - to handle first-responder tasks on GitHub issues and pull requests.
