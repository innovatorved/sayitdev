#compdef dev
# dev(1) zsh completion - generated by `dev completions zsh`
_dev() {
  ...
  _arguments -s \
    ...
    '-i[Attach an image to prompt for vision]:file:_files' \
    '--image[Attach an image to prompt for vision]:file:_files' \
    ...
    '--rate[TTS speaking rate]:value:' \
    '--audio-format[TTS output format]:value:(wav pcm aac)' \
