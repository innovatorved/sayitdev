"""
dev Integration Tests — OpenAI API Schema Validation

Validates that dev's server responses conform to the OpenAI API schema
...
# ============================================================================
# Health Endpoint Schema (dev-specific, not OpenAI)
# ============================================================================
