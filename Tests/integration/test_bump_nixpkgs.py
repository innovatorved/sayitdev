"""
dev Integration Tests - scripts/bump-nixpkgs.sh.

The bump-nixpkgs.sh script is a pure shell tool that updates dev-llm's
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "https://example.com/dev-${finalAttrs.version}.tar.gz";
...
def workspace(tmp_path):
    ...
    tarball = tmp_path / "dev-1.3.3-arm64-macos.tar.gz"
