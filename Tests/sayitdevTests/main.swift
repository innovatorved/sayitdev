...
suite("SayItDevErrorTests") { runSayItDevErrorTests() }
...
suite("SayItDevErrorMessageTests") { runSayItDevErrorMessageTests() }
suite("OpenAIWireFormatTests") { runOpenAIWireFormatTests() }
suite("SayItDevCorePublicAPIUsageTests") { runSayItDevCorePublicAPIUsageTests() }
